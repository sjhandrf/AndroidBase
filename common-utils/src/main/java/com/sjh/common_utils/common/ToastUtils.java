...
public final class ToastUtils {
    ...
    private static int sYOffset = (int) (64 * Utils.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setGravity(int gravity, int xOffset, int yOffset) {
        ...
        ToastUtils.sXOffset = xOffset;
        ToastUtils.sYOffset = yOffset;
    }
    ...
    public static void setView(@LayoutRes int layoutId) {
        ...
        ToastUtils.sCustomView = inflate.inflate(layoutId, null);
    }
    ...
    public static View getView() {
        if (sCustomView != null) return sCustomView;
     ...
     * @param duration 显示时长
     */
    private static void show(CharSequence text, View customView, int gravity, int xOffset, int yOffset, int duration) {
        View view = null;
        if (sCustomView != null) {
            view = sCustomView;
        }
        ...
        cancel();
        if (view != null) {
            sToast = Toast.makeText(Utils.getContext(), "", duration);
            sToast.setView(view);
    ...
    private static void show(CharSequence text, int duration) {
        show(text, null, sGravity, sXOffset, sYOffset, duration);
    }
